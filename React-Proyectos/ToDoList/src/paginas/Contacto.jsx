...
import "../estilos/estiloFormularioContacto.css"; // Asegúrate de tener este archivo
...
function Contacto() {
  ...
  const validar = () => {
    ...
    if (!form.nombre.trim()) {
      ...
      !/^[A-ZÁÉÍÓÚÑ][a-záéíóúñ]+(?:\s[A-ZÁÉÍÓÚÑ][a-záéíóúñ]+)*$/.test(form.nombre)
    ) {
    ...
    if (!form.mensaje.trim()) {
      ...
      nuevosErrores.mensaje =
        "El mensaje debe tener entre 1 y 100 caracteres";
    }
